...
export default function Login() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-surface-light">
      <div className="hidden lg:flex flex-col justify-between bg-academic-green text-white p-12">
        ...
        <div>
          ...
          <h1 className="font-heading text-4xl font-bold leading-tight mb-3">
            Stay close to
            <br /> your child's journey.
          </h1>
          <p className="text-white/80 font-sub max-w-sm">
            Attendance, homework, fees, bus tracking, and teacher messages — everything a parent needs, in one place.
          </p>
        </div>
        ...
        <div className="w-full max-w-sm">
          ...
          {step === 1 ? (
            <form onSubmit={handleCredentials} className="space-y-4">
              ...
              <button
                disabled={loading}
                className="w-full bg-academic-green text-white rounded-xl py-2.5 font-medium hover:bg-academic-green/90 transition-colors disabled:opacity-60"
              >
