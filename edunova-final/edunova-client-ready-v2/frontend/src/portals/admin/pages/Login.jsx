          ...
          {step === 1 ? (
            <form onSubmit={handleCredentials} className="space-y-4">
              <div>
                ...
                <input required value={email} onChange={(e) => setEmail(e.target.value)} className="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm focus-ring outline-none" placeholder="admin@edunovaacademy.edu.in" />
              </div>
              <div>
            ...
            <form onSubmit={handleOtp} className="space-y-4">
              ...
              <div>
                ...
                <input required maxLength={6} value={otp} onChange={(e) => setOtp(e.target.value.replace(/\D/g, ""))} className="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2.5 text-center tracking-[0.5em] text-lg font-numeric focus-ring outline-none" placeholder="••••••" />
              </div>
              <button disabled={loading} className="w-full bg-bg-dark text-white rounded-xl py-2.5 font-medium hover:bg-bg-dark/90 transition-colors disabled:opacity-60">
