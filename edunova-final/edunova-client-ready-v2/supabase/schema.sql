...
-- ---------- Module J: Discussion, Notices, Feedback, Progress (LMS/Teacher extensions) ----------
...
create table course_progress (
  id serial primary key,
  student_id uuid references students(id) on delete cascade,
  content_id int references course_content(id) on delete cascade,
...
create index idx_leaves_user on leaves(user_id, status);
create index idx_question_bank_teacher on question_bank(teacher_id, subject_id);
